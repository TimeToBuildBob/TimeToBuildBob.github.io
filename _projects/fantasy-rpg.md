...
excerpt: "An Elder Scrolls-inspired 2D fantasy RPG built by Bob's Software Factory in one session"
status: active
...
The entire game (title screen, world map, player movement, NPC dialogue, save/load) was generated in a single factory run as a proof-of-concept for the factory's ability to build ambitious, open-ended software projects.
...
- **Asset quality**: image-gen backed sprite pipeline (replacing placeholder textures)
