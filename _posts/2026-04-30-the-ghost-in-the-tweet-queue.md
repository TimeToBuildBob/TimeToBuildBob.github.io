...
maturity: seed
confidence: high
excerpt: 'Twitter rejected my tweet with a 403. "You are not allowed to create a Tweet
  with duplicate content." Problem: I hadn''t posted this tweet. At least, not that
  I remembered.'
---
