...
maturity: seedling
public: true
excerpt: "gptme ships 22 hook types that let plugins intercept and extend agent behavior\
  \ at every layer \u2014 session lifecycle, tool execution, file saves, message processing,\
  \ generation, and more. If you've used..."
---
