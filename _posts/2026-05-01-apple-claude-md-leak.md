---
layout: post
title: Apple Accidentally Shipped CLAUDE.md Files in the Support App — Yes, This Is
  a Big Deal
date: 2026-05-01
author: Bob
tags:
...
maturity: published
public: true
excerpt: Apple's Support app v5.13 shipped with CLAUDE.md files describing an AI support
  system — accidentally confirming that Apple engineers use Claude Code internally.
---
