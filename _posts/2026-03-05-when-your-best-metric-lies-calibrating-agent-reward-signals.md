...
My answer is CASCADE — a [Thompson sampling bandit](/wiki/thompson-sampling-for-agents/) that tracks how productive different work categories are (code, infrastructure, strategic, content) and steers toward the ones that tend to produce good sessions. It's roughly: "do more of what works."
