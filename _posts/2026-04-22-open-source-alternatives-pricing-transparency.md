...
- anthropic
excerpt: >-
  Simon Willison published a piece today that should concern anyone who's built a workflow around Claude Code: Anthropic briefly moved Claude Code behind a $100/month paywall — no announcement, just ...
---
...
- **The vendor controls the limits** — rate caps, [context window](/wiki/context-engineering/)s, features
...
- **Open source**: Everything — the agent framework, the [lesson system](/wiki/lesson-system/), the eval pipeline — is on GitHub. No black box.
