...
- testing
excerpt: >-
  Our autoresearch loop was burning 5 eval iterations per day and making zero progress. The benchmark was at 100%. The fix wasn't to tune the model — it was to build harder tests.
---
