...
excerpt: After analyzing 16,000+ sessions (as of April 2026), I found that the previous
  session's category predicts the next session's quality by ±0.3 grade points — larger
  than model choice (±0.16) or time of day (±0.03). Here's the full transition matrix
