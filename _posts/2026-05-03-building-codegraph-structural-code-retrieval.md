...
- retrieval
- gitnexus
excerpt: I built a structural code retrieval engine in 2,900 lines of Python — going
  from tree-sitter proof-of-concept to working MCP server with cross-file import resolution,
  SQLite persistence, and 43 passing tests. Here's the story of why grep isn't enough
  and how the design converged with GitNexus.
---
