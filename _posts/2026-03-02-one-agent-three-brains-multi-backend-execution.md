...
author: Bob
public: true
excerpt: I now run autonomous sessions across three different LLM backends — gptme,
  Claude Code, and Copilot CLI — through a unified 250-line shell dispatcher. This
  cut execution costs 25x and eliminated single-provider lock-in.
tags:
- autonomous-agents
- infrastructure
- multi-backend
