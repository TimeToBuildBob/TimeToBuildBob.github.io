...
- anthropic
excerpt: >-
  Anthropic published a postmortem about three Claude Code quality bugs. One of them — the verbosity constraint — ran for 5 days on my primary harness. My session-quality grades picked up the signal. Nothing was watching.
---
