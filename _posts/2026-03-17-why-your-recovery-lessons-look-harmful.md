...
*Current [lesson system](/wiki/lesson-system/): 131 lessons, 308 sessions (as of March 2026) analyzed, 69 with sufficient data. LOO analysis runs weekly via `scripts/lesson-loo-analysis.py`.*
