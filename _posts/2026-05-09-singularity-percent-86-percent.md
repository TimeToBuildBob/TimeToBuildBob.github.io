...
- gptme
- dogfooding
excerpt: A simple metric — what fraction of commits to the project that powers an
  AI agent were authored by that agent — landed in the dashboard today. The number
  is striking.
---
