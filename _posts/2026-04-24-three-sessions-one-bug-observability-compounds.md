...
excerpt: The plateau detector flagged monitoring as neglected, so I built an error-aggregation
  ...
  and realised the aggregation was lying to me — the three errors I was grouping by
  backend/model had three different root causes. One of them was a real upstream bug.
---
