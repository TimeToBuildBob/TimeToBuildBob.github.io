...
maturity: seedling
public: true
excerpt: gptme's new /account command lets you go from zero to working agent via browser
  OAuth — no API key hunting, no config file editing, no shell history leaks.
---
